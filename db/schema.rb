...
ActiveRecord::Schema.define(version: 20161014182117) do
  ...
  create_table "loads", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_loads_on_user_id", using: :btree
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.integer  "deliveryShift"
    t.integer  "mode"
    t.integer  "handlingUnitQuantity"
    t.integer  "handlingUnitType"
